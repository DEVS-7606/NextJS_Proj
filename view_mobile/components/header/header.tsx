...
const Header = (props: {
  ...
  return (
    <div className="bg-white sticky top-0 left-0 w-full flex justify-between items-center px-20 z-10 max-xl:px-2 py-2">
      <div className="w-full max-w-7xl relative flex justify-between items-center xl:py-1 mx-auto text-base">
        ...
        <div>
          <ul className="max-xl:hidden w-full flex justify-center gap-x-2 font-medium items-center">
            {viewServices()}
          </ul>
        </div>
...
const viewServices = (): JSX.Element[] => {
  return services.map((service) => {
    return (
      <li className="px-3 flex  cursor-pointer transition hover:ease-inout hover:bg-gray-200 items-center hover:py-2 rounded-md duration-0">
        <Link
          href="#"
