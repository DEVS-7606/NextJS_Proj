...
const HeroSection: () => JSX.Element = () => {
  ...
  const renderPropertyExploreSection = () => {
    return (
      <>
        ...
        <p className="font-normal lg:text-lg  xs:text-base text-sm  xs:w-3/4 w-full ">
          ...
          keep on top of your property search with the latest real estate
          listings for sale, rent, recently sold, as well as unlisted
          properties.
        </p>
      </>
    );
